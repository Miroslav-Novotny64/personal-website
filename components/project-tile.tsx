    ...
    <div className={cn("grid grid-cols-1", isGrid ? "flex flex-col h-full" : "lg:grid-cols-12")}>
      ...
      <div className={cn("relative", isGrid ? "flex-1" : "lg:col-span-6")}>
        <div className={cn(
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                {tags.slice(0, 3).map(tag => (
                   <span key={tag} className="text-[10px] font-mono text-muted-foreground/60 uppercase">
                     {tag}
                   </span>
                ))}
              </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-4 border-t border-border/5">
            {liveUrl && (
              <a 
                href={liveUrl} 
                target="_blank" 
              ...
              >
                {tCommon("live")}
                <Globe size={11} className="group-hover/btn:rotate-12 transition-transform" />
              </a>
            )}
            {repoUrl && (
              <a 
            ...
            {fileUrl && (
              ...
              >
                {tCommon("paper")}
                <FileText size={11} className="group-hover/btn:rotate-12 transition-transform" />
              </a>
            )}
