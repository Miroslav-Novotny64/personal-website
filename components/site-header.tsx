              ...
              <div className="p-6 border-t border-border/10 space-y-6 mt-auto">
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <a href={tLinks("github")} target="_blank" rel="noopener noreferrer me" className="text-muted-foreground/60 hover:text-primary transition-colors">
                      ...
                      <a href={tLinks("linkedin")} target="_blank" rel="noopener noreferrer me" className="text-muted-foreground/60 hover:text-primary transition-colors">
