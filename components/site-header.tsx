...
export function SiteHeader() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: trigger on navigation
  useEffect(() => {
    setIsOpen(false);
  }, [pathname]);
    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-10 lg:px-24 h-14 border-b border-border/20 bg-background/70 backdrop-blur-md">
        ...
        <div className="lg:hidden flex items-center">
          <Link
            href="/"
            className="group flex items-center gap-2 font-mono text-[13px] font-bold tracking-[0.2em] text-primary uppercase transition-all duration-300"
          >
