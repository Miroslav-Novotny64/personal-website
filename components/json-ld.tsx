export function JsonLd() {
  ...
  const personSchema = {
    ...
    "description": "Student IT směřující na ČVUT FIT s praxí ve full-stack vývoji. Specializující se na Next.js, Javu (Spring Boot).",
    "sameAs": [
      "https://github.com/Miroslav-Novotny64",
      "https://www.linkedin.com/in/miroslavnovotny64/"
    ],
    "image": `${domain}/expertov-lg.png`,
    "knowsAbout": ["Next.js", "Java", "Spring Boot", "Rust", "TypeScript", "SQL", "Python", "Linux"]
  };
