...
export function SiteFooter() {
  ...
  return (
    <footer className="relative z-20 border-t border-border/30">
      <div className="max-w-none px-10 lg:px-24 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-6 font-mono text-[10px] tracking-widest uppercase">
          <a href={tLinks("github")} target="_blank" rel="noopener noreferrer me" className="flex items-center gap-2 text-muted-foreground/50 hover:text-primary transition-colors duration-200">
          ...
          <a href={tLinks("linkedin")} target="_blank" rel="noopener noreferrer me" className="flex items-center gap-2 text-muted-foreground/50 hover:text-primary transition-colors duration-200">
