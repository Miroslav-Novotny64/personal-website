...
<Gallery images={[{ src: "/expertov/showcase1.png", caption: "Hlavní přehled eventů v aplikaci" }, { src: "/expertov/showcase2.png", caption: "Přehled statistik v rámci eventu" }, { src: "/expertov/showcase3.png", caption: "Administrační rozhraní pro správu eventů" }, { src: "/expertov/showcase4.png", caption: "Celkový žebříček soutěžících" }, { src: "/expertov/showcase5.png", caption: "Statistiky a historické výsledky" }]} />
