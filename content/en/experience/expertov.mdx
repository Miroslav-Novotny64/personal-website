...
The entire development lifecycle—from initial database schema design and competitor analysis to beta testing results (during the 2025 Ice Hockey World Championship)—is documented in my graduation thesis.

<Button href="/maturitni-prace.pdf" icon="download">
  Read Graduation Thesis (PDF) (In czech)
</Button>
